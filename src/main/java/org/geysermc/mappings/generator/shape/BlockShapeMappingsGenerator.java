...
public final class BlockShapeMappingsGenerator extends AbstractShapeMappingsGenerator {
    private static final Logger LOGGER = LogUtils.getLogger();

    public BlockShapeMappingsGenerator(PackOutput output) {
        super(output, FileType.BLOCK_SHAPE_MAPPINGS);
    }
    ...
    public String getName() {
        return "Block Shape Mappings Generator";
    }
}
